    ...
    <div className='flex items-center justify-between'>
      ...
      <div className='menu'>
        <ul className='flex items-center gap-10 '>
          ...
          <li><a className='text-smallTextColor font-[600]' href='#service'>Services</a></li>
