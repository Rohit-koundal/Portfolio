        ...
        <div className="md:flex items-center jsutify-between sm:flex-col md:flex-row">
          <div className="w-full md:basis-1/2">
            ...
            >
              ...
              With over 5+ years of professional experience as a Frontend
              Engineer, I have demonstrated expertise in Angular, React.js, and
              multiple programming languages. My collaborative work ethic shines
              in both team settings and independent projects, reflecting a solid
              grasp of object-oriented analysis. Dedicated to enhancing systems
              and technologies, I implement programming design patterns and best
              practices. With excellent communication skills and a keen eye for
              detail, I efficiently tackle complex tasks. Equipped with
              analytical prowess and strong problem-solving abilities, I
              consistently deliver high-quality solutions autonomously.
            </p>
